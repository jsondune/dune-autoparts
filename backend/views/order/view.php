...
<div class="order-view">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        ...
        <div class="d-flex gap-2">
            ...
            <?php if (in_array($model->order_status, ['pending', 'confirmed'])): ?>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center position-relative px-4">
                ...
                $currentIndex = array_search($model->order_status, $statuses);
                if ($model->order_status == 'cancelled') $currentIndex = -1;
                
                foreach ($statuses as $i => $status):
                    $isActive = ($i <= $currentIndex);
                    $isCurrent = ($model->order_status == $status);
                ?>
                ...
                <?php if ($model->order_status == 'cancelled'): ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-8">
                        ...
                        <table class="table mb-0">
                            ...
                            <tfoot class="table-light">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><?= Yii::$app->formatter->asCurrency($model->shipping_cost, 'THB') ?></td>
                                </tr>
                                <tr class="fw-bold">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center">
                    ...
                    <?php if ($model->order_status != 'cancelled' && $model->payment_status != 'paid'): ?>
        ...
        <div class="col-xl-4">
            <!-- Actions -->
            <?php if ($model->order_status != 'cancelled' && $model->order_status != 'delivered'): ?>
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-transparent border-0">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <?php if ($model->order_status == 'confirmed'): ?>
                        ...
                        <?php if ($model->order_status == 'preparing'): ?>
                        ...
                        <?php if ($model->order_status == 'shipped'): ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-6">
                            ...
                            <?= Yii::$app->formatter->asCurrency($model->shipping_cost, 'THB') ?>
                        </div>
                    </div>
