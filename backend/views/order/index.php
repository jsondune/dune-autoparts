...
<div class="order-index">
    ...
    <div class="row g-3 mb-4">
        <div class="col">
            <a href="<?= Url::to(['index', 'OrderSearch[order_status]' => 'pending']) ?>" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100 <?= Yii::$app->request->get('OrderSearch')['order_status'] ?? '' == 'pending' ? 'border-warning' : '' ?>">
        ...
        <div class="col">
            <a href="<?= Url::to(['index', 'OrderSearch[order_status]' => 'confirmed']) ?>" class="text-decoration-none">
        ...
        <div class="col">
            <a href="<?= Url::to(['index', 'OrderSearch[order_status]' => 'preparing']) ?>" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
        ...
        <div class="col">
            <a href="<?= Url::to(['index', 'OrderSearch[order_status]' => 'shipped']) ?>" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center py-3">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            ...
            <div class="col-md-2">
                <?= Html::activeDropDownList($searchModel, 'order_status', [
                    'pending' => 'รอยืนยัน',
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-center"><?= $dataProvider->sort->link('order_status', ['label' => 'สถานะ']) ?></th>
