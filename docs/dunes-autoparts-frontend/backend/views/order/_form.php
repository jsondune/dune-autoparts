    ...
    customerSearchTimeout = setTimeout(function() {
        $.get('/backend/web/customer/search-ajax', {q: query}, function(data) {
            ...
            data.forEach(function(customer) {
                html += '<div class="customer-result" data-id="' + customer.id + '" data-name="' + customer.name + '" data-phone="' + customer.phone + '" data-address="' + (customer.address || '') + '">';
