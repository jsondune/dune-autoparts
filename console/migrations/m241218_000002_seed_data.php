...
class m241218_000002_seed_data extends Migration
{
    ...
    //         'email_address' => 'superadmin@dunesautoparts.com',
    ...
    //         'username' => 'staff',
    //         'auth_key' => Yii::$app->security->generateRandomString(),
    //         'password_hash' => Yii::$app->security->generatePasswordHash('Staff@123!'),
    ...
    //     ]);
        ...
        $settings = [
            ['setting_key' => 'company_name', 'setting_value' => 'ดูน ออโต้ พาร์ท', 'setting_type' => 'text', 'setting_group' => 'general', 'setting_description' => 'ชื่อบริษัท'],
            ['setting_key' => 'company_phone', 'setting_value' => '02-XXX-XXXX', 'setting_type' => 'text', 'setting_group' => 'general', 'setting_description' => 'เบอร์โทรศัพท์'],
            ['setting_key' => 'company_email', 'setting_value' => 'info@dunesautoparts.com', 'setting_type' => 'text', 'setting_group' => 'general', 'setting_description' => 'อีเมล'],
            ['setting_key' => 'company_address', 'setting_value' => 'กรุงเทพมหานคร', 'setting_type' => 'textarea', 'setting_group' => 'general', 'setting_description' => 'ที่อยู่'],
            ['setting_key' => 'company_tax_id', 'setting_value' => '', 'setting_type' => 'text', 'setting_group' => 'general', 'setting_description' => 'เลขประจำตัวผู้เสียภาษี'],
            ['setting_key' => 'business_hours_open', 'setting_value' => '08:30', 'setting_type' => 'text', 'setting_group' => 'business', 'setting_description' => 'เวลาเปิดทำการ'],
            ['setting_key' => 'business_hours_close', 'setting_value' => '17:30', 'setting_type' => 'text', 'setting_group' => 'business', 'setting_description' => 'เวลาปิดทำการ'],
            ['setting_key' => 'shipping_cutoff', 'setting_value' => '14:00', 'setting_type' => 'text', 'setting_group' => 'business', 'setting_description' => 'เวลาตัดรอบจัดส่ง'],
            ['setting_key' => 'low_stock_threshold', 'setting_value' => '5', 'setting_type' => 'number', 'setting_group' => 'inventory', 'setting_description' => 'จำนวนสินค้าน้อย (แจ้งเตือน)'],
            ['setting_key' => 'default_warranty_days', 'setting_value' => '7', 'setting_type' => 'number', 'setting_group' => 'inventory', 'setting_description' => 'วันรับประกันสินค้ามือสอง (วัน)'],
            ['setting_key' => 'order_prefix', 'setting_value' => 'SO', 'setting_type' => 'text', 'setting_group' => 'order', 'setting_description' => 'รหัสนำหน้าเลขที่คำสั่งซื้อ'],
            ['setting_key' => 'customer_prefix', 'setting_value' => 'CUST', 'setting_type' => 'text', 'setting_group' => 'customer', 'setting_description' => 'รหัสนำหน้าเลขที่ลูกค้า'],
            ['setting_key' => 'chatbot_enabled', 'setting_value' => '1', 'setting_type' => 'boolean', 'setting_group' => 'chatbot', 'setting_description' => 'เปิดใช้งาน AI Chatbot'],
            ['setting_key' => 'chatbot_welcome_message', 'setting_value' => 'สวัสดีครับ! ยินดีให้บริการครับ มีอะไรให้ช่วยครับ?', 'setting_type' => 'textarea', 'setting_group' => 'chatbot', 'setting_description' => 'ข้อความต้อนรับ Chatbot'],
        ];
    ...
    {
        $this->delete('{{%system_settings}}');
        $this->delete('{{%part_category}}');
        $this->delete('{{%vehicle_brand}}');
        $this->delete('{{%users}}', ['username' => ['superadmin', 'admin', 'staff']]);
